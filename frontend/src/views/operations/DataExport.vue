<template>
  <div class="page-container">
    <el-card shadow="never" class="page-card">
      ...
      <el-row :gutter="16">
        <el-col v-for="item in exports" :key="item.type" :xs="24" :sm="12" :md="8">
...
const exports = [
  { type: 'students', title: '学生列表', desc: '导出当前权限范围内学生基础信息' },
  { type: 'teachers', title: '教师列表', desc: '导出教师基础信息' },
  { type: 'courses', title: '课程列表', desc: '导出课程和任课教师信息' },
  { type: 'schedules', title: '课表', desc: '导出课程、班级、教师、教室和时间' },
  { type: 'scores', title: '成绩列表', desc: '导出当前权限范围内成绩' },
  { type: 'transcript', title: '成绩单', desc: '学生导出本人，管理员可按接口参数扩展' },
]
